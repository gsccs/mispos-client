...
public class BackupManage {
    ...
    public static boolean exportDatabase(String hostIP, String userName, String password, String databaseName) {
        StatusLog.setStatusDetail(PropUtil.getProperty("ds.logic.backuping"), LogLevel.INFO);
        boolean isSuccess = true;
        ...
        try {
            ...
            for (String string : list) {
                StatusLog.setStatusDetail(PropUtil.getProperty("ds.logic.backupTable") + string, LogLevel.INFO);

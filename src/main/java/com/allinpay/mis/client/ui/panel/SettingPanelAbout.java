...
public class SettingPanelAbout extends JPanel {
	...
	private JPanel getCenterPanel() {
		...
		// 初始化组件
		JLabel labelAdvice = new JLabel(PropUtil.getProperty("ds.ui.app.advice"));
		JLabel labelHelp = new JLabel(PropUtil.getProperty("ds.ui.app.help"));
	...
	private JPanel getDownPanel() {
		...
		JLabel labelInfo = new JLabel(PropUtil.getProperty("ds.ui.app.info"));

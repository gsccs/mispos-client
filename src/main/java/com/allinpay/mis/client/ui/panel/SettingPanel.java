...
public class SettingPanel extends JPanel {
	...
	private JPanel getUpPanel() {
		...
		JLabel labelTitle = new JLabel(PropUtil.getProperty("ds.ui.setting.title"));
	...
	private JPanel getCenterPanel() {
		...
		JLabel labelOption = new JLabel(PropUtil.getProperty("ds.ui.setting.option"));
		JLabel labelAbout = new JLabel(PropUtil.getProperty("ds.ui.setting.about"));

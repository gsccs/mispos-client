...
public class DatabasePanel extends JPanel {
	...
	private JPanel getUpPanel() {
		...
		JLabel labelTitle = new JLabel(PropUtil.getProperty("ds.ui.database.title"));
	...
	private JPanel getCenterPanel() {
		...
		JLabel labelFrom = new JLabel(PropUtil.getProperty("ds.ui.database.label.from"));
		JLabel labelTo = new JLabel(PropUtil.getProperty("ds.ui.database.label.to"));
		Font fontListItem = new Font(PropUtil.getProperty("ds.ui.font.family"), 0, 15);

...
import com.allinpay.mis.client.ui.panel.BackupPanel;
import com.allinpay.mis.client.ui.panel.DatabasePanel;
import com.allinpay.mis.client.ui.panel.SchedulePanel;
import com.allinpay.mis.client.ui.panel.SettingPanel;
import com.allinpay.mis.client.ui.panel.StatusPanel;
import com.allinpay.mis.client.ui.panel.ToolBarPanel;
...
public class AppMainWindow {
            ...
            public void windowClosing(WindowEvent e) {
                if (!StatusPanel.buttonStartSchedule.isEnabled()) {
                    JOptionPane.showMessageDialog(AppMainWindow.statusPanel,
                            PropUtil.getProperty("ds.ui.mainwindow.exitconfirm"), "Sorry~", JOptionPane.WARNING_MESSAGE);
                } else {
    ...
    private void addDialog() {
        // 数据库备份对话框
        dialog = new JDialog(frame, PropUtil.getProperty("ds.ui.mainwindow.dialog.newBackUp"), true);
        ...
        JLabel labelType = new JLabel(PropUtil.getProperty("ds.ui.mainwindow.dialog.type"));
        JLabel labelComment = new JLabel(PropUtil.getProperty("ds.ui.mainwindow.dialog.remarks"));
        JLabel labelProgress = new JLabel(PropUtil.getProperty("ds.ui.mainwindow.dialog.progress"));
        JComboBox<String> comboxType = new JComboBox<>(new String[]{PropUtil.getProperty("ds.ui.mainwindow.dialog.comboxType0"),
                PropUtil.getProperty("ds.ui.mainwindow.dialog.comboxType1"), PropUtil.getProperty("ds.ui.mainwindow.dialog.comboxType2"),
                PropUtil.getProperty("ds.ui.mainwindow.dialog.comboxType3")});
        ...
        JButton buttonSure = new JButton(PropUtil.getProperty("ds.ui.sure"));
        JButton buttonCancel = new JButton(PropUtil.getProperty("ds.ui.cancel"));
